  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: TextCustom(TheText: "tDeliverLists".tr, TheTextSize: 14),
        centerTitle: true,
      ),
      body: Column(
        children: [
                ...
                Expanded(
                  child: Container(
                    ...
                    child: TextFormFieldSimpleCustom(
                      ...
                      labelText: 'tSearchDeliver'.tr,
                      labelStyleColor: THelperFunctions.isDarkMode(context)
                          ? ColorApp.tWhiteColor
                          : ColorApp.tBlackColor,
                      hintText: 'tSearchDeliver'.tr,
              ...
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return InkWell(
                      onTap: () {
                        Get.offAll(() => DeliverDetailScreen(userId: UserModel.ref!.id,));
                      },
                      child: Padding(
                        padding: const EdgeInsets.all(10),
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              child: Center(
                                child: Expanded(
                                  child: TextCustom(
                                    TheText: UserModel.isAvailable ? "Disponible" : "Indisponible",
                                    TheTextSize: 12,
                                    TheTextFontWeight: FontWeight.bold,
